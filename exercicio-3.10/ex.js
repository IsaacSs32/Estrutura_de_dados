...
function lerArquivo(nomeArquivo) {
    return __awaiter(this, void 0, void 0, function () {
        var fileStream, rl, conteudo, _a, rl_1, rl_1_1, line, e_1_1;
        var _b, e_1, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    fileStream = fs.createReadStream(nomeArquivo);
                ...
                case 12: return [2 /*return*/, conteudo];
            }
        });
    });
}
...
function contarOcorrencias(texto) {
    ...
    var palavras = textoLimpo.split(/\s+/);
    var contagem = {};
    ...
    var pontuacoes = [",", ";", ".", ":"];
    for (var _a = 0, pontuacoes_1 = pontuacoes; _a < pontuacoes_1.length; _a++) {
        var pontuacao = pontuacoes_1[_a];
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var nomeArquivo, conteudo, ocorrencias, _i, _a, _b, palavra, contagem;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    nomeArquivo = "texto/teste1.txt";
                    return [4 /*yield*/, lerArquivo(nomeArquivo)];
                case 1:
                    conteudo = _c.sent();
                    ocorrencias = contarOcorrencias(conteudo);
                    for (_i = 0, _a = Object.entries(ocorrencias); _i < _a.length; _i++) {
                        _b = _a[_i], palavra = _b[0], contagem = _b[1];
                        console.log("".concat(palavra, ": ").concat(contagem));
                    }
                    return [2 /*return*/];
            }
        });
